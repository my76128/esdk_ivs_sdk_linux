...
#include "IVSPlayerDataType.h"
	...
	#endif
#else
	#define IVS_PLAYER_API __attribute__((visibility("default")))
#endif
...
*****************************************************************************/
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_Init(const char* pLogPath = NULL);
...
/***************************************************************************
 ...
 返 回 值 : 成功:IVS_SUCCEED;失败:IVS_FAIL;
***************************************************************************/
IVS_PLAYER_API IVS_VOID __SDK_CALL IVS_PLAY_SetExceptionCallBack(
...
/*****************************************************************************
 ...
 返 回 值：成功:IVS_SUCCEED;失败:IVS_FAIL;
 *****************************************************************************/
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_OpenStream(IVS_ULONG ulChannel, IVS_UINT32 uiPlayeMode, IVS_UINT32 uiSourceType);
...
/*****************************************************************************
 ...
 返 回 值：成功:IVS_SUCCEED;失败:IVS_FAIL;
*****************************************************************************/
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_GetVolume(IVS_ULONG ulChannel, IVS_UINT32* puiVolumeValue);
...
/*****************************************************************************
 ...
 返 回 值：成功:IVS_SUCCEED;失败:IVS_FAIL;
*****************************************************************************/
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_SetRawFrameCallBack(IVS_ULONG ulChannel, REASSM_CALLBACK cbReassmCallBack, void *pUser);
...
/*****************************************************************************
 ...
 返 回 值：成功:IVS_SUCCEED;失败:IVS_FAIL;
*****************************************************************************/
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_SetFrameCallBack(IVS_ULONG ulChannel, DECODER_CALLBACK fnDecoderCB, void *pUser);
...
****************************************************************************/
#ifdef WIN32
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_AddPlayWindow(IVS_ULONG ulChannel, HWND hWnd, int nType, void *pLayout);
#endif
...
****************************************************************************/
#ifdef WIN32
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_AddPlayWindowPartial(IVS_ULONG ulChannel, HWND hWnd, LAYOUT_DRAW_PARTIAL *pPartial);
#endif
...
****************************************************************************/
#ifdef WIN32
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_UpdateWindowPartial(IVS_ULONG ulChannel, HWND hWnd, LAYOUT_DRAW_PARTIAL *pPartial);
#endif
...
****************************************************************************/
#ifdef WIN32
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_DelPlayWindow(IVS_ULONG ulChannel, HWND hWnd);
#endif
...
/*****************************************************************************
 ...
 返 回 值：成功:IVS_SUCCEED;失败:IVS_FAIL;
 *****************************************************************************/
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_InputFrameData(IVS_ULONG ulChannel, IVS_RAW_FRAME_INFO* pstRawFrameInfo, IVS_CHAR* pFrame, IVS_UINT32 uFrameSize);
...
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_SetDownLoadTimeSpan(IVS_ULONG ulChannel, time_t tmBeg, time_t tmEnd, IVS_BOOL bReportFinsh);
 ...
 *****************************************************************************/
#ifdef WIN32
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_SetDrawCallBack(IVS_ULONG ulChannel, 
	                     DRAW_CALLBACK callback, void *pUser);

IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_SetDrawCallBackEx(IVS_ULONG ulChannel,
...
/*****************************************************************************
 ...
 返 回 值： ULONG
*****************************************************************************/
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_SetMicVolume(IVS_UINT32 ulVolumeValue);
...
/*****************************************************************************
 ...
 返 回 值： ULONG
*****************************************************************************/
IVS_PLAYER_API IVS_INT32 __SDK_CALL IVS_PLAY_StartVoiceTalkback(IVS_CHAR* pLocalIp, IVS_ULONG ulLocalPort, 
