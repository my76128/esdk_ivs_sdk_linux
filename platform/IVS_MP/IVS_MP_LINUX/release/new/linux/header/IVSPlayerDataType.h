...
返 回 值： ULONG
*****************************************************************************/
typedef  IVS_VOID (__SDK_CALLBACK * PLAYER_EXCEPTION_CALLBACK)(IVS_ULONG  ulChannel,     // 通道号;
...
返 回 值： ULONG
*****************************************************************************/
typedef  IVS_VOID (__SDK_CALLBACK * PLAYER_EVENT_CALLBACK)(IVS_ULONG  ulChannel,
                                                     IVS_INT32  iMsgType,
                                                     IVS_VOID*  pParam,
                                                     IVS_VOID*  pUser);
...
// 组帧回调
typedef IVS_VOID (__SDK_CALLBACK * REASSM_CALLBACK)(IVS_RAW_FRAME_INFO* pstRawFrameInfo,
											  IVS_CHAR*           pFrame,
...
typedef IVS_VOID (__SDK_CALLBACK * DECODER_CALLBACK)(IVS_INT32   iStreamType,
                                               IVS_VOID*   pFrameInfo,
                                               IVS_VOID*   pUser);
...
/* 播放回调 */
typedef IVS_VOID (__SDK_CALLBACK * DISPLAY_CALLBACK)(IVS_UINT32 nType, IVS_UCHAR *pBuf,
                                               IVS_UINT32 nWidth, IVS_UINT32 nHeight,
                                               IVS_UINT32 nTimeStamp, IVS_VOID *pUser);

/* 画图回调 */
#ifdef WIN32
typedef IVS_VOID (__SDK_CALLBACK * DRAW_CALLBACK)(HDC hDc, RECT *rc, IVS_UINT64 FrameID, IVS_VOID *pUser);
#endif

/* 播放结束回调 */
typedef IVS_VOID (__SDK_CALLBACK * PLAYEND_CALLBACK)(IVS_VOID *pUser);
